...
2. Problem - when I added empty space for button the button randomly shifted in its place
Solution - setting fixed height and width, adding border box and flex